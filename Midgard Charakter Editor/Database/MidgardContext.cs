...
namespace MidgardCharakterEditor.Database
{
    public class MidgardContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Skill>().HasData(new Skill(1, "Abwehr", "gw", "Kampf", 10, 10));
            modelBuilder.Entity<Skill>().HasData(new Skill(2, "Akrobatik", "gw", "Bewegung", 8, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(3, "Alchemie", "in", "Wissen", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(4, "Anführen", "pa", "Sozial", 8, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(5, "Athletik", "st", "Körperbeherrschung", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(6, "Balancieren", "gw", "Bewegung", 12, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(7, "Beidhändiger Kampf", "gs", "Kampf", 5, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(8, "Beredsamkeit", "pa", "Sozial", 8, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(9, "Betäuben", "gs", "Kampf", 8, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(10, "Bootfahren", "gs", "Bewegung", 12, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(11, "Erste Hilfe", "gs", "Fingerfertigkeit", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(12, "Etikette", "in", "Sozial", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(13, "Fälschen", "gs", "Fingerfertigkeit", 12, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(14, "Fallen entdecken", "in", "Entdeckung", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(15, "Fallenmechanik", "gs", "Fingerfertigkeit", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(16, "Fechten", "gs", "Kampf", 5, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(17, "Gassenwissen", "in", "Sozial", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(18, "Gaukeln", "gs", "Fingerfertigkeit", 12, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(19, "Geländelauf", "gw", "Bewegung", 12, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(20, "Gerätekunde", "in", "Wissen", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(21, "Geschäftssinn", "in", "Sozial", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(22, "Glücksspiel", "gs", "Fingerfertigkeit", 12, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(23, "Heilkunde", "in", "Wissen", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(24, "Kampf in Vollrüstung", "st", "Kampf", 5, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(25, "Klettern", "st", "Bewegung", 12, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(26, "Landeskunde", "in", "Wissen", 8, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(27, "Laufen", "ko", "Bewegung", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(28, "Lesen von Zauberschrift", "in", "Wissen", 8));
            modelBuilder.Entity<Skill>().HasData(new Skill(29, "Meditieren", "wk", "Körperbeherrschung", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(30, "Menschenkenntnis", "in", "Sozial", 8, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(31, "Meucheln", "gs", "Kampf", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(32, "Musizieren", "gs", "Fingerfertigkeit", 12));
            modelBuilder.Entity<Skill>().HasData(new Skill(33, "Naturkunde", "in", "Wissen", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(34, "Pflanzenkunde", "in", "Wissen", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(35, "Reiten", "gw", "Bewegung", 12, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(36, "Reiterkampf", "gw", "Kampf", 12, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(37, "Geistresistenz", "in", "Körperbeherrschung", 10, 10));
            modelBuilder.Entity<Skill>().HasData(new Skill(38, "Körperresistenz", "ko", "Körperbeherrschung", 10, 10));
            modelBuilder.Entity<Skill>().HasData(new Skill(39, "Scharfschießen", "gs", "Kampf", 5, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(40, "Schleichen", "gw", "Bewegung", 8, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(41, "Schlösser öffnen", "gs", "Fingerfertigkeit", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(42, "Schreiben: Sprache", "in", "Wissen", 8));
            modelBuilder.Entity<Skill>().HasData(new Skill(43, "Schwimmen", "gw", "Bewegung", 12, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(44, "Seilkunst", "gs", "Fingerfertigkeit", 12, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(45, "Sprechen: Sprache", "in", "Wissen", 8));
            modelBuilder.Entity<Skill>().HasData(new Skill(46, "Spurensuche", "in", "Entdeckung", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(47, "Stehlen", "gs", "Fingerfertigkeit", 8, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(48, "Tarnen", "gw", "Entdeckung", 8, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(49, "Tauchen", "ko", "Bewegung", 8, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(50, "Tierkunde", "in", "Wissen", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(51, "Überleben: Gebirge", "in", "Wissen", 8, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(52, "Überleben: Steppe", "in", "Wissen", 8, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(53, "Überleben: Wald", "in", "Wissen", 8, 6));
            modelBuilder.Entity<Skill>().HasData(new Skill(54, "Verführen", "pa", "Sozial", 8, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(55, "Verhören", "pa", "Sozial", 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(56, "Verstellen", "pa", "Sozial", 8, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(57, "Wagenlenken", "gs", "Bewegung", 12, 3));
            modelBuilder.Entity<Skill>().HasData(new Skill(58, "Zauberkunde", "in", "Wissen", 8, 0));
            modelBuilder.Entity<Skill>().HasData(new Skill(59, "Zaubern", "zt", "Zaubern", 3, 3));
            // Waffengruppen
            modelBuilder.Entity<Skill>().HasData(new Skill(60, "Einhandschlagwaffen", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(61, "Einhandschwerter", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(62, "Fechtwaffen", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(63, "Kettenwaffen", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(64, "Spießwaffen", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(65, "Stichwaffen", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(66, "Stockwaffen", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(67, "Zauberstäbe", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(68, "Zweihandschlagwaffen", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(69, "Zweihandschwerter", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(70, "Waffenloser Kampf", null, "Nahkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(71, "Schilde", null, "Verteidigungswaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(72, "Parierwaffen", null, "Verteidigungswaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(73, "Stielwurfwaffen", null, "Fernkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(74, "Wurfklingen", null, "Fernkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(75, "Wurfscheiben", null, "Fernkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(76, "Wurfspieße", null, "Fernkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(77, "Armbrüste", null, "Fernkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(78, "Blasrohre", null, "Fernkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(79, "Bögen", null, "Fernkampfwaffe", 5));
            modelBuilder.Entity<Skill>().HasData(new Skill(80, "Schleudern", null, "Fernkampfwaffe", 5));
