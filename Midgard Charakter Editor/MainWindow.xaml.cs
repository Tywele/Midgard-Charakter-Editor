...
namespace Midgard_Charakter_Editor
{
	...
	public partial class MainWindow : Window
	{
		public MainWindow()
		{
            ...
            var path = @"C:\Liste der Waffengruppen - M5(prepped).csv";
            using (TextFieldParser csvParser = new TextFieldParser(path))
            {
                ...
                while (!csvParser.EndOfData)
                {
                    ...
                    line = $"modelBuilder.Entity<SkillHasCategory>().HasData(new SkillHasCategory({counter}, {fields[4]}, {fields[3]}, {fields[1]}));";
                    counter++;
